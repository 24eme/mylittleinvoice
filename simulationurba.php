...
$ficlog=$grc_config['urba']['path']."/txt/facturation".$annee."-".$insee.".txt";
$ficrecap=$grc_config['urba']['path']."/recap/facturation".$annee."-".$insee.".txt";
...
//	$quantite = $population;
//	$texte = "Population INSEE au 01/01/".$annee." : ".strval($population)." habitants. Soit ".number_format($cotis_type_1,2,'.','')." EUR / habitant plafonné à ".number_format($cotis_plafond,2,'.','')." EUR";
//}
//*************************************
//Lignes de facturation Urbanisme pour intégration dans le CRM
//*************************************
