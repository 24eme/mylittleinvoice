...
$set_entry_parameters = array(
    ...
    "name_value_list" => array(
		...
		array("name" => "billing_account_id", "value" => utf8_decode($numeroid)),
		array("name" => "shipping_account_id", "value" => utf8_decode($numeroid)),
		array("name" => "name", "value" => utf8_decode("Facturation Service DPD 2eme semestre 2018 ".$pieces[1])),
		array("name" => "billing_address_street", "value" => utf8_decode($pieces[2])),
		array("name" => "billing_address_city", "value" => utf8_decode($pieces[4])),
		array("name" => "billing_address_postalcode", "value" => utf8_decode($pieces[3])),
		array("name" => "shipping_address_street", "value" => utf8_decode($pieces[2])),
		array("name" => "shipping_address_city", "value" => utf8_decode($pieces[4])),
		array("name" => "shipping_address_postalcode", "value" => utf8_decode($pieces[3])),
		array("name" => "shipping_stage", "value" => "Shipped"),
		array("name" => "invoice_date", "value" => utf8_decode($pieces[5])),
		array("name" => "due_date", "value" => utf8_decode($pieces[6])),
		array("name" => "amount", "value" => utf8_decode($pieces[7])),
		array("name" => "amount_usdollar", "value" => utf8_decode($pieces[7])),
		array("name" => "amount_due", "value" => utf8_decode($pieces[7])),
		array("name" => "amount_due_usdollar", "value" => utf8_decode($pieces[7])),
		//array("name" => "gross_profit", "value" => "0.00"),
		//array("name" => "gross_profit_usdoller", "value" => "0.00"),
		//array("name" => "pretax", "value" => utf8_decode($pieces[7])),
		//array("name" => "pretax_usd", "value" => utf8_decode($pieces[7])),
		array("name" => "subtotal", "value" => utf8_decode($pieces[7])),
		array("name" => "subtotal_usd", "value" => utf8_decode($pieces[7])),
    ),
);
