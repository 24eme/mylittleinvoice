...
if (isset($_GET["consult"])) 
{
	...
	$nomdefichier = $grc_config['urba']['path']."/txt/facturation".$annee."-".$consult_insee.".txt";
}
else
{
	echo "</body></html>";
...
echo "<div class='col-md-4'>".utf8_encode($name_facturation_urba)." - ".utf8_encode($pieces[1])."</div>";
echo "</div>";
